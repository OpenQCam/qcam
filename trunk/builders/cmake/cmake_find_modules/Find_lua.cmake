...
#SET(LUA_INCLUDE_PATH "${CRTMPSERVER_3RDPARTY_ROOT}/lua-dev")
  SET(LUA_INCLUDE_PATH "${CRTMPSERVER_3RDPARTY_ROOT}/lua-5.2.2/src")
  MESSAGE(STATUS "Looking for lua headers - not found. Defaulting to ${CRTMPSERVER_3RDPARTY_ROOT}/lua-5.2.2/src")
...
IF(LUA_FOUND)
  ...
  ELSE(LUA_LIBRARY_PATH_)
    ...
    SET(LUA_INCLUDE_PATH "${CRTMPSERVER_3RDPARTY_ROOT}/lua-dev")
    MESSAGE(STATUS "Looking for lua library - not found. Lua library will be compiled from ${CRTMPSERVER_3RDPARTY_ROOT}/lua-5.2.2")
