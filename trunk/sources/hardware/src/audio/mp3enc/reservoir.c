 ...
 */
void ResvFrameBegin(L3_side_info_t *l3_side, int mean_bits, int frameLength, config_t *config )
{
  //int fullFrameBits;
  ...
  if(config->mpeg.type==1 ) resvLimit = 4088; /* main_data_begin has 9 bits in MPEG 1 */
