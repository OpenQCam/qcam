...
namespace app_flvplayback {
	...
	class TestCLIAppProtocolHandler
	: public BaseCLIAppProtocolHandler {
	public:
		TestCLIAppProtocolHandler(Variant &configuration);
		virtual ~TestCLIAppProtocolHandler();
    bool ProcessMessage(BaseProtocol *pFrom, Variant &message);
	};
}
