...
OutboundHTTPProtocol::OutboundHTTPProtocol(uint64_t protocolType)
...
//wrap http header and send to tcp protocol
...
#if 0
//do not wrap http header 
bool OutboundHTTPProtocol::WebSocketEnqueueForOutbound() {
