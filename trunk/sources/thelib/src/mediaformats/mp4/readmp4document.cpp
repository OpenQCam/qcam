...
#ifdef HAS_MEDIA_MP4
#include "mediaformats/mp4/readmp4document.h"
...
ReadMP4Document::ReadMP4Document(Variant &metadata)
: BaseMP4Document(metadata) {
	_pFTYP = NULL;
	_pMOOV = NULL;
}

ReadMP4Document::~ReadMP4Document() {
...
#if 0
void ReadMP4Document::AddAtom(BaseAtom *pAtom) {
	ADD_VECTOR_END(_allAtoms, pAtom);
}
#endif

BaseAtom* ReadMP4Document::ReadAtom(BaseAtom *pParentAtom) {
...
bool ReadMP4Document::ParseDocument() {
...
bool ReadMP4Document::BuildFrames() {
	_frames.clear();
...
bool ReadMP4Document::BuildMOOVFrames(bool audio) {
	//1. Get the track
...
bool ReadMP4Document::BuildMOOFFrames(AtomMOOF *pMOOF, bool audio) {
...
Variant ReadMP4Document::GetRTMPMeta() {
	Variant result;
...
string ReadMP4Document::Hierarchy() {
	string result = "";
...
AtomTRAK * ReadMP4Document::GetTRAK(bool audio) {
	if (_pMOOV == NULL) {
...
AtomTRAF * ReadMP4Document::GetTRAF(AtomMOOF *pMOOF, bool audio) {
