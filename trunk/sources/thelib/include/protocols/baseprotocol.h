...
public:
  ...
  // Tim: To make interface coherent, add below methods
  // For approtocolhandler to protocol or  streamm to protocol,
  // remember to call EnqueueForOutbound() after return
