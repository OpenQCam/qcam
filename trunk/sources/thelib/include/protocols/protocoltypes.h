...
//HTTP WebSocket protocols connection
#define PT_OUTBOUND_HTTP_WSCONNECTION MAKE_TAG5('O','H','W','S','C')
#define PT_INBOUND_HTTP_WSCONNECTION  MAKE_TAG5('I','H','W','S','C')
#define PT_WEBSOCKET_SUBPROTOCOL      MAKE_TAG3('W','S','S')
...
#define PT_INBOUND_JSONRESTCLI   MAKE_TAG4('I','J','R','C')

#define PT_INBOUND_XMLCLI    MAKE_TAG7('I','X','M','L','C','L','I')
#define PT_INBOUND_XMLRESTCLI   MAKE_TAG4('I','X','R','C')

#define PT_HTTP_4_CLI     MAKE_TAG3('H','4','C')
//#define PT_HTTP_4_QICCLI      MAKE_TAG4('H','4','Q','C')

//Raw HTTP stream
#define PT_INBOUND_RAW_HTTP_STREAM    MAKE_TAG4('I','R','H','S')
#define PT_INBOUND_AV_HTTP_STREAM   MAKE_TAG5('I','A','V','H','S')

//pass through protocol
#define PT_PASSTHROUGH MAKE_TAG2('P','T')

//MJPG HTTP stream
#define PT_INBOUND_MJPG_HTTP_STREAM   MAKE_TAG4('I','J','H','S')

//GPIO pipe protocol
#define PT_GPIOPIPE   MAKE_TAG4('G','P','I','O')

//UNIX Domain socket protocol
#define PT_UNIX_DOMAIN_SOCKET MAKE_TAG3('U','D','S')
#define PT_UDS_RECORD   MAKE_TAG4('U','D','S','R')
#define PT_UDS_COMMAND   MAKE_TAG4('U','D','S','C')
#define PT_UDS_IVA   MAKE_TAG4('U','D','S','I')
//#define PT_UNIX_DOMAIN_SOCKET_TEST   MAKE_TAG7('U','D','S','T','E','S','T')
