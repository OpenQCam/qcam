 ...
 */
static inline int get_more_data_ps(PS_reader_p   ps)
{
                            ...
                            byte   stream_id)
{
  ...
  case 0xB9: str = (char*)"PS MPEG_program_end_code"; break;
  case 0xBA: str = (char*)"PS Pack header start code"; break;
  case 0xBB: str = (char*)"PS System header start code"; break;
  case 0xBC: str = (char*)"PS Program stream map"; break;
  case 0xFF: str = (char*)"PS Program stream directory"; break;

    // Other "simple" values from H.222 Table 2-18, page 32
  case 0xBD: str = (char*)"Private stream 1"; break;
  case 0xBE: str = (char*)"Padding stream"; break;
  case 0xBF: str = (char*)"Private stream 2"; break;
  case 0xF0: str = (char*)"ECM stream"; break;
  case 0xF1: str = (char*)"EMM stream"; break;
  case 0xF2: str = (char*)"DSMCC stream"; break;
  case 0xF3: str = (char*)"13522 stream"; break;
  case 0xF4: str = (char*)"H.222.1 A stream"; break;
  case 0xF5: str = (char*)"H.222.1 B stream"; break;
  case 0xF6: str = (char*)"H.222.1 C stream"; break;
  case 0xF7: str = (char*)"H.222.1 D stream"; break;
  case 0xF8: str = (char*)"H.222.1 E stream"; break;
  case 0xF9: str = (char*)"Ancillary stream"; break;

  case 0x00: str = (char*)"H.262 Picture"; break;
  case 0xB2: str = (char*)"H.262 User data"; break;
  case 0xB3: str = (char*)"H.262 Sequence header"; break;
  case 0xB4: str = (char*)"H.262 Sequence error"; break;
  case 0xB5: str = (char*)"H.262 Extension"; break;
  case 0xB7: str = (char*)"H.262 Sequence end"; break;
  case 0xB8: str = (char*)"H.262 Group start"; break;
...
{
  int  err;
  PS_reader_p newone = (PS_reader_p)malloc(SIZEOF_PS_READER);
  if (newone == NULL)
  {
  ...
  err = get_more_data_ps(newone);
  if (err)
  {
    print_err("### Unable to start reading from newone PS read context\n");
    free(newone);
    return 1;
  }

  // And look for the first pack header
  err = find_PS_pack_header_start(newone,FALSE,PACK_HEADER_SEARCH_DISTANCE,
                                  &(newone->start));
  if (err)
  {
  ...
  if (input != STDIN_FILENO)
  {
    ...
    err = seek_using_PS_reader(newone,newone->start);
    if (err)
    {
                              ...
                              struct program_data *prog_data)
{
  ...
  if (frame_count == 0 || offset <= 1 || !got_pts)
  {
    ...
    // However, first we need to create a newone packet that does not
