...
public:
	AtomHDLR(BaseMP4Document *pDocument, uint32_t type, uint64_t size, uint64_t start);
	AtomHDLR(BaseMP4Document *pDocument, uint32_t componentType, uint32_t subType, string componentName);
	virtual ~AtomHDLR();
