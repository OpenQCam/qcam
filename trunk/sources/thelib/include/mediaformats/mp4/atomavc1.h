...
private:
  ...
  uint16_t _height;
public:
	AtomAVC1(BaseMP4Document *pDocument, uint32_t type, uint64_t size, uint64_t start);
	AtomAVC1(BaseMP4Document *pDocument, uint16_t width, uint16_t height, uint16_t frame, uint16_t depth);
	virtual ~AtomAVC1();
