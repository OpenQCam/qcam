...
//	vector<AtomMOOF*> _moof;
  vector<BaseAtom *> _dumyAtoms;


public:
	BaseMP4Document(Variant &metadata);
	virtual ~BaseMP4Document();

	virtual void AddAtom(BaseAtom *pAtom, bool isTopAtom=false);
	virtual BaseAtom * ReadAtom(BaseAtom *pParentAtom);
...
protected:
	...
	virtual bool ParseDocument() { NYI; return false;}
	virtual bool BuildFrames() { NYI; return false;}
	virtual Variant GetRTMPMeta() {return _metadata;}
