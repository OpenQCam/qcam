...
//#define PROFILING_VIDEO
//#define PROFILING_AUDIO
#define PROFILING_NETWORK
//#define PROFILING_TIMER
//#define PROFILING_UNIXDOMAIN
...
#ifdef PROFILING
  bool OnEventVerbose(select_event &event);
#endif
  /*!
