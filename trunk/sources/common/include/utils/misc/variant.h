...
public:
  ...
  void SetParentKeyName(string name);
  ...
  static bool DeserializeFromIControlXml(const uint8_t *pBuffer, uint32_t bufferLength,
      Variant &result);
  static bool DeserializeFromIControlXml(string data, Variant &result);
  static bool DeserializeFromIControlXml(TiXmlElement *pNode, Variant &variant);

  TiXmlElement *SerializeToIControlXmlElement(string &name);
  bool SerializeToIControlXml(string &result, bool prettyPrint = true);
